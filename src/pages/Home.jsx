    ...
    <div className="w-full my-8">
      <div className="max-w-[1200px] mx-8 xl:mx-auto">
        <h2 className="text-center text-4xl font-semibold my-5">
          Stress Test Your CodeForces Solution
        </h2>

        <div>
          <div className="py-10">
            <div className="text-red-800 m-auto text-center font-bold">
              {testError}
            </div>
        ...
        <div className="mt-8">
          <p>
            Brute-force? Generator? Checker? Interactor? Validator? Forget about
            all of those.
          </p>
          <p>
            We do all the dirty work, so you can focus on what you do best:{" "}
