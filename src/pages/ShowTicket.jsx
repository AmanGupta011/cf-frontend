// status of the ticket reflected on this page
    ...
    <div>
      <div className="max-w-[1200px] mx-8 xl:mx-auto">
        ...
        <h1 className="text-center mt-4">
          <span className="text-2xl font-semibold mt-8 py-2">
            Submission ID -{" "}
          </span>{" "}
          <a
            className="text-2xl text-blue-600 font-medium my-4"
            href={`https://codeforces.com/contest/${ticket.problem.contest_id}/submission/${ticket.submission.id}`}
            target="_blank"
          >{`${ticket.submission.id}`}</a>
        </h1>
        <div className="mt-4">
      ...
      {ticket.progress === "processed" && ticket.verdict === true && (
        <div className="max-w-[1200px] mx-8 xl:mx-auto flex flex-col justify-center mt-3">
          <div className="w-full text-xl bg-zinc-300 mt-8 py-2 flex flex-row justify-between items-center px-4">
            ...
            <div>
              <span
                ...
                onClick={(e) =>
                  navigator.clipboard.writeText(ticket.testcase.input)
                }
              >
                <FaRegCopy />
              </span>
          ...
          <pre className="bg-zinc-100 px-4 py-3">{ticket.testcase.input}</pre>
          <div className="w-full text-xl bg-zinc-300 mt-8 py-2 flex flex-row justify-between items-center px-4">
          ...
          <div className="w-full text-xl bg-zinc-300 mt-8 py-2 flex flex-row justify-between items-center px-4">
            ...
            <div>
              <span
                className="cursor-pointer"
                onClick={(e) =>
                  navigator.clipboard.writeText(ticket.testcase.jury_output)
                }
              >
                <FaRegCopy />
              </span>
