...
const Test = () => {
  ...
  const testComponent = (
    <div className="w-full my-8">
      <div className="max-w-[1200px] mx-8 xl:mx-auto">
        ...
        <div>
          <input
            ...
            className="shadow appearance-none border rounded w-full py-4 px-3 leading-tight focus:outline-none focus:shadow-outline font-semibold text-xl"
            placeholder="Example: 173167476"
          />
        </div>
      </div>
      <div className="max-w-[1200px] mx-8 xl:mx-auto flex flex-row justify-center mt-6">
        <div
          onClick={submit}
          className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-green-500 rounded-md hover:bg-green-400 sm:w-auto sm:mb-0 cursor-pointer"
  ...
  return user?.name ? testComponent : <Navigate to="/login" />;
};
