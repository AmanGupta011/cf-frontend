  ...
  const navbarComponent = (
    <div className="w-screen h-[80px] z-10 bg-zinc-200 drop-shadow-lg">
      <div className="px-10 flex justify-between items-center w-full h-full">
        <div className="flex items-center">
          ...
          <ul className="hidden md:flex">
            ...
            <li>
              <Link to="/status" offset={-200}>
                Status
              </Link>
            </li>
            <li>
              <Link to="/about" offset={-200}>
                About
              </Link>
            </li>
            <li>
        ...
        {user?.name ? (
          <div className="hidden md:flex pr-4">
            ...
            <div>
              <button className="px-8 py-3" onClick={submit}>
                Logout
              </button>
            </div>
          </div>
      ...
      <ul className={!nav ? "hidden" : "absolute bg-zinc-200 w-full px-8"}>
        ...
        <li className="border-b-2 border-zinc-300 w-full">
          <Link onClick={handleClose} to="/status">
            Status
          </Link>
        </li>
        <li className="border-b-2 border-zinc-300 w-full">
          <Link onClick={handleClose} to="/about" offset={-200}>
            About
          </Link>
        </li>
        <li className="border-b-2 border-zinc-300 w-full">
          <Link onClick={handleClose} to="/contact" offset={-200}>
            Contact
          </Link>
        </li>
        ...
        {user?.name ? (
          <div className="flex flex-col my-4">
            ...
            <div>
              <button className="px-8 py-3" onClick={handleClose}>
                Logout
              </button>
            </div>
          </div>
